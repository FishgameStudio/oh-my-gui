...
## Supported Versions
We provide security updates and fixes for the following project versions.
Older versions are not maintained anymore, please upgrade to a supported release.
...
Public disclosure may put users at risk.
...
## Scope
This security policy applies to all source code, official examples and built artifacts of Oh-My-GUI.
